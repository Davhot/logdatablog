    ...
    $.extend($.summernote.plugins, {
        ...
        'highlight': function (context) {
            ...
            this.createDialog = function () {
                ...
                var languages = [
                  'ruby', 'c', 'csharp', 'coffeescript', 'css', 'd', 'go',
                  'haskell', 'html', 'java', 'javascript', 'json', 'lua', 'php',
                  'python', 'r', 'scheme', 'shell', 'smalltalk'
                ];
            ...
            this.createCodeNode = function (code, select) {
                var $code = $('<code>');
                $code.html(code);
                $code.attr('data-language', select);
